...
#            print(ma200_list[arrLen-shift])
        ...
        ax2.plot(t, ma200_list, color='red', lw=2, label='MA ('+str(ma2)+'):'+str(ma200_list[299]))
        ax2.plot(t, ma300_list, color='#336666', lw=2, label='MA ('+str(ma3)+')'+str(ma300_list[299]))
        ax2.plot(t, ma400_list, color='#ffff33', lw=2, label='MA ('+str(ma4)+')'+str(ma400_list[299]))
        ax2.plot(t, ma500_list, color='#33ff66', lw=2, label='MA ('+str(ma5)+')'+str(ma500_list[299]))
#        ax2.plot(t, ma200_list, color='red', lw=2, label='MA (200)')
